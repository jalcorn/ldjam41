	...
	private void refreshFrames() {
		...
		switch (state) {
			case playerMoveState.walkUp:
				...
				currentSprites[1] = allSprites[9];
				currentSprites[2] = allSprites[10];
				currentSprites[3] = allSprites[11];
				animationLength = 4;
				break;
			case playerMoveState.walkDown:
				currentSprites[0] = allSprites[0];
				currentSprites[1] = allSprites[1];
				currentSprites[2] = allSprites[2];
				currentSprites[3] = allSprites[3];
				animationLength = 4;
				break;
			...
			case playerMoveState.walkRight:
				...
				currentSprites[2] = allSprites[6];
				currentSprites[3] = allSprites[7];
				animationLength = 4;
